...
autoscaledy = (originaly - originaly.mean()) / originaly.std(ddof=1)

# construct GTMR model
inputdataset = np.c_[ autoscaledX, autoscaledy]
...
# inverse analysis
estimatedxmean, estimatedxmode, responsibilities_inverse, py = model.inversegtmr( targetyvalue)
